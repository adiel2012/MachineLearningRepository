...
def getdata(dataset_name):
    ...
    (x, y) = loadDS(os.path.abspath('..\\datasets\\'+dataset_name+'\\train\\'))
    (xt, yt) = loadDS(os.path.abspath('..\\datasets\\'+dataset_name+'\\test\\'))
...
def train_classification_model(model, dataset_name, batch_size, nb_classes, nb_epoch, img_rows, img_cols, img_channels, data_augmentation = False):
    #batch_size = 32
    #nb_classes = 10
    #nb_epoch = 200
