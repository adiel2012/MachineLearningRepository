...
def train_classification_model(model, dataset_name, batch_size, nb_classes, nb_epoch, img_rows, img_cols, img_channels, data_augmentation = False, reshapeTo = None,  featurewise_center=False, samplewise_center=False,  featurewise_std_normalization=False,  samplewise_std_normalization=False):
    #batch_size = 32
    #nb_classes = 10
    #nb_epoch = 200
